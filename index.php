...
<html>
<head>
<title>Benjamin Zagorski - Web Developer</title>
<!-- for-mobile-apps -->
...
<div class="banner">
	<div class="container" id="banner_container">
		...
		<div class="banner-text">
			...
			<h2 id="title_display">Web Developer</h2>
			<a href="Resume-BenjaminZagorski.pdf" class="hvr-bounce-to-right" target="_blank">DOWNLOAD MY RESUME</a>
		</div>
	</div>
</div>
<!--about-->
